                                ...
                                <cfloop query = allMovieShowTimeList>
                                    <tr>
                                        ...
                                        <cfoutput>
                                            ...
                                            <td>#(dateformat(allMovieShowTimeList.releaseDate,"dd-mm-yyyy"))#</td>
                                            <td>#(timeFormat(allMovieShowTimeList.showStartTime, "hh:mm tt"))#</td>
                                            ...
                                            <cfset sec=s_d[3]>
                                            <cfset dtn=hours+min>                            
                                            <cfset new_time = timeFormat(DateAdd("s",dtn,#allMovieShowTimeList.showStartTime#),'hh:mm tt')>
                                            <td>#new_time#</td> 
                                            <td>#(dateformat(allMovieShowTimeList.endDate,"dd-mm-yyyy"))#</td>
