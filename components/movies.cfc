<cfcomponent>
    ...
    <cffunction name="movieCreateForm" access="remote" output="true">
        ...
        <cfif len(trim(local.aErrorMessages)) NEQ 0>
            ...
            <cflocation addtoken="no"  url="../pages/managemovies.cfm?aMessages=#local.encryptedMessage#">
        <cfelse>
            ...
            <cflocation addtoken="no"  url="../pages/managemovies.cfm?aMessageSuccess=#local.encryptedMessage#"> 
        </cfif>
    </cffunction>
