...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/packages.min.css">
    ...
    <div class="container">
        <div class="row">
           <div class="col-md-6 col-sm-6 col-xs-4">
                <a href="./" id="logo" title="Tenguu" class="logo-image-white" data-bg-image="assets/images/logo-white.png">Tenguu
                </a>
            </div>
             <div class="col-md-5 col-md-offset-1 col-sm-6 col-xs-8 phl0">
                <div class="header_author">
                    <a href="#">Amanda green</a>
                    <img src="assets/images/user.png" class="user" alt="user">
                </div>
...
</header><section class="section-content pv12 bg-cover" data-bg-image="assets/images/blog/bg-single.jpg">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <article class="blog-item single" >
                    <div class="col-md-4 col-sm12 post-image hover-dark" data-bg-image="assets/images/blog/single_thumb.jpg">
                        <a href="https://vimeo.com/28177848" class="video-player"><i class="fa fa-play"></i></a>
                    </div>
                    <div class="col-md-8 col-sm-12 col-xs-12 ph0">
                        <div class="post-content bg-cover" data-bg-image="assets/images/blog/post-single.jpg">
                            <div class="content-meta"> 
                                <h2 class="entry-title">Lord of the rings: The return 
                                of the king
                                <span>Synopsis</span>
                                </h2>
                            ...
                            <p class="entry-text">Continually aggregate cross-platform opportunities vis-a-vis high-quality intellectual capital. Efficiently aggregate seamless "outside the box" thinking for enterprise growth strategies. Assertively cultivate top-line ROI and timely relationships authoritatively matrix.</p>
                            <div class="info-content">
                                <ul class="item-info">
                                    <li><span>Running Time:</span>  <p>1hr 48 min</p></li>
        ...
        <div class="row">
                <div class="col-md-12 mt4">
                   <div class="single-slider">
                        <div class="swiper-container movie-assets/images" id="singleslider" data-col="5">
                            <div class="swiper-wrapper">
                                                                    <div class="swiper-slide">
                                        <div class="movie-image" data-bg-image="assets/images/carousel/movie-1.jpg">
                                            <div class="entry-hover">
                                                <div class="entry-actions">
                                                    <a href="javascript:;" class="btn fill">More</a>
                                                </div>
                                            </div>
                                            <div class="entry-desc">
                                                ...
                                                <ul class="entry-date">
                                                    <li>5 May 2017</li>  
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <div class="movie-image" data-bg-image="assets/images/carousel/movie-2.jpg">
                                            <div class="entry-hover">
                                                <div class="entry-actions">
                                                    <a href="javascript:;" class="btn fill">More</a>
                                                </div>
                                            ...
                                            <div class="entry-desc">
                                                ...
                                                <ul class="entry-date">
                                                    <li>5 May 2017</li>  
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <div class="movie-image" data-bg-image="assets/images/carousel/movie-3.jpg">
                                            <div class="entry-hover">
                                                <div class="entry-actions">
                                                    <a href="javascript:;" class="btn fill">More</a>
                                                </div>
                                            ...
                                            <div class="entry-desc">
                                                ...
                                                <ul class="entry-date">
                                                    <li>5 May 2017</li>  
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <div class="movie-image" data-bg-image="assets/images/carousel/movie-4.jpg">
                                            <div class="entry-hover">
                                                <div class="entry-actions">
                                                    <a href="javascript:;" class="btn fill">More</a>
                                                </div>
                                            ...
                                            <div class="entry-desc">
                                                ...
                                                <ul class="entry-date">
                                                    <li>5 May 2017</li>  
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <div class="movie-image" data-bg-image="assets/images/carousel/movie-5.jpg">
                                            <div class="entry-hover">
                                                <div class="entry-actions">
                                                    <a href="javascript:;" class="btn fill">More</a>
                                                </div>
                                            ...
                                            <div class="entry-desc">
                                                ...
                                                <ul class="entry-date">
                                                    <li>5 May 2017</li>  
                                                                    ...
                                                                    <div class="swiper-slide">
                                        <div class="movie-image" data-bg-image="assets/images/carousel/movie-6.jpg">
                                            <div class="entry-hover">
                                                <div class="entry-actions">
                                                    <a href="javascript:;" class="btn fill">More</a>
                                                </div>
...
<div class="section-content pvb0">
                    ...
                    <div class="comments-wrapper">
                        ...
                        <ol class="comment-list">
                            <li>
                                <article>
                                    <div class="comment-avatar">
                                        <img alt="Image" src="assets/images/blog/user-1.jpg" class="avatar">
                                    </div>
                            ...
                            <li>
                                <article>
                                    <div class="comment-avatar">
                                        <img alt="Image" src="assets/images/blog/user-2.jpg" class="avatar">
                                    </div>
                                    <div class="comment-body">
                                        <div class="meta-data">
    ...
    <script type="text/javascript" src="assets/js/packages.min.js"></script>
